    ...
    <div class="payment-container">
        <div class="qr-column">
            ...
            <div class="buttons-container">
                ...
                <form action="${pageContext.request.contextPath}/payment" method="POST" style="flex:1;">
        ...
        <div class="order-section">
            <div class="order-card">
                ...
                <div class="detail-row">
                    ...
                    <c:forEach var="item" items="${flatCart}"><c:set var="totalQty" value="${totalQty + item.quantity}" /></c:forEach>
