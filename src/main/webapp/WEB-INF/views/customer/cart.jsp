						...
						<div class="container">
													...
													<div class="item-details">
														...
														<div class="item-actions">
															...
															<c:forEach var="fav" items="${favoriteList}">
																<c:if
																	test="${fav.item.itemId == item.itemId && fav.outlet.outletId == item.outletId}">
																	<c:set var="isFavorite" value="true" />
																</c:if>
															</c:forEach>

															<form
																action="${pageContext.request.contextPath}/profile/favorites/toggle"
																...
																<input type="hidden" name="outletId"
																	value="${item.outletId}">
																<button type="submit"
																	class="icon-heart ${isFavorite ? 'active' : ''}">
																	♥
																</button>
															</form>
							...
							<div class="right-container">
								...
								<c:choose>
									...
									<c:otherwise>
										<button class="checkout-btn" disabled style="background: #ccc;">Proceed To
											Checkout</button>
									</c:otherwise>
								</c:choose>
							</div>
