...
<body>
    ...
    <div class="contact-container">
        ...
        <% } else { %>
            ...
            <div class="feedback-form" style="text-align:center; padding:40px;">
                <h2>Send us your feedback</h2>
    ...
    <% if (request.getAttribute("success") != null) { %>
        <div style="color:green; text-align:center; margin:20px; font-weight:bold;">
            <%= request.getAttribute("success") %>
        </div>
    <% } %>
    <% if (request.getAttribute("error") != null) { %>
        <div style="color:red; text-align:center; margin:20px; font-weight:bold;">
