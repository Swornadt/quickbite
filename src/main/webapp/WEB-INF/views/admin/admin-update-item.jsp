...
<div class="admin-body">
        <div class="admin-right-body">
            <main class="content">
                ...
                <div class="form-container">
                    ...
                    <form action="<%=request.getContextPath()%>/EditItem" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="itemName" value="${item != null ? item.itemName : ''}" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select name="itemStatus">
                <option value="Available" ${item != null && item.itemStatus == 'Available' ? 'selected' : ''}>Available</option>
                <option value="Not Available" ${item != null && item.itemStatus == 'Not Available' ? 'selected' : ''}>Not Available</option>
            </select>
        </div>

        <div class="form-group full-width">
            <label>Description</label>
            <textarea name="itemDescription">${item != null ? item.itemDescription : ''}</textarea>
        </div>
        <div class="form-group full-width">
            <label>Ingredients</label>
            <textarea name="itemIngredient">${item != null ? item.itemIngredient : ''}</textarea>
        </div>
        <div class="form-group full-width">
        ...
        <div class="form-group full-width current-image-container">
            ...
            <c:if test="${item != null && item.itemImage != null && not empty item.itemImage}">
