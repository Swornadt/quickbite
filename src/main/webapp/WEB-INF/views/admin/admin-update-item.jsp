                ...
                <div class="form-container">
                    ...
                    <form action="<%=request.getContextPath()%>/EditItem" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="itemType" value="${item.itemType}">
                        </div>
                        <div class="form-group">
                            <label>Price</label>
                        ...
                        <div class="form-group">
                            ...
                            <select name="itemStatus">
                                <option value="Available" ${item.itemStatus == 'Available' ? 'selected' : ''}>Available</option>
                                <option value="Not Available" ${item.itemStatus == 'Not Available' ? 'selected' : ''}>Not Available</option>
                            </select>
                        </div>

                        <div class="form-group full-width">
                            <label>Description</label>
                            <textarea name="itemDescription">${item.itemDescription}</textarea>
                        </div>
                        <div class="form-group full-width">
                            <label>Ingredients</label>
                            <textarea name="itemIngredient">${item.itemIngredient}</textarea>
                        </div>
                        <div class="form-group full-width">
                            <label>Allergies</label>
                            <textarea name="itemAllergy">${item.itemAllergy}</textarea>
                        </div>
