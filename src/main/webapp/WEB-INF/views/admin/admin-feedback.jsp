                    ...
                    ★
                                        ...
                                        <div class="stat-card">
                                            ...
                                            <c:forEach var="star" begin="1" end="5">
                                                ...
                                                <c:set var="percentage"
                                                    value="${totalFeedback > 0 ? (count / totalFeedback * 100) : 0}" />
                                    ...
                                    <c:forEach var="fb" items="${feedbackList}">
                                        <div class="feedback-card">
                                            <img src="${pageContext.request.contextPath}/${fb.userImage}" alt="User"
                                                class="user-image" />
                                            ...
                                            <div class="feedback-content">
                                                <div class="feedback-header">
                                                    ...
                                                    <div class="rating-date">
                                                        ...
                                                        <c:forEach begin="1" end="5" var="i">
                                                            <span
                                                                style="color: ${i <= fb.ratingValue ? '#f59e0b' : '#e5e7eb'};">
                                                                ★
                                                            </span>
                                                        </c:forEach>
                                                        <span class="date">
                                                            <fmt:formatDate value="${fb.ratingDate}"
                                                                pattern="dd-MM-yyyy" />
                                                        </span>
                                                    </div>
                                                </div>
                                    ...
                                    <c:if test="${empty feedbackList}">
                                        <div
                                            style="text-align: center; padding: 60px 20px; color: #6b7280; font-size: 18px;">
